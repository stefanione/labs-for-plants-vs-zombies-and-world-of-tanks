...
void Lab2::Init()
{
    ...
    // turret(body)
    {
        ...
        {
            VertexFormat(glm::vec3(-2, -0.5f,  0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, -0.5f,  0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.2, 0.1, 0.2)),
            VertexFormat(glm::vec3(-2, 0,  0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.2, 0.0, 0.3)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.1, 0.8, 0.6)),
            VertexFormat(glm::vec3(-2, -0.5f,  3), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.1, 0.7, 0.4)),
            VertexFormat(glm::vec3(0, -0.5f,  3), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.4, 0.9, 0.2)),
            VertexFormat(glm::vec3(-2, 0,  3), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.4, 0.98, 0.4)),
            VertexFormat(glm::vec3(0, 0,  3), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.1, 0.5, 0.1))
            // TODO(student): Complete the vertices data for the cube mesh
...
void Lab2::Update(float deltaTimeSeconds)
{
  ...
  //  RenderMesh(meshes["box"], shaders["VertexNormal"], glm::vec3(0, 0.5f, -1.5f), glm::vec3(0.75f));
    ...
    // draw turret(body)
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-0.25f, 0.5f, 0.3f), glm::vec3(0.25f));

    // draw tank(body)
    RenderMesh(meshes["cube_C"], shaders["VertexColor"], glm::vec3(0, 0.25f, 0), glm::vec3(0.5f));

    //draw turret(barrell)
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-0.35f, 0.5f, 0.8f), glm::vec3(0.15f));

    //// TODO(student): Draw the tetrahedron
    //RenderMesh(meshes["quad"], shaders["VertexColor"], glm::vec3(3, 0.5f, 0), glm::vec3(0.5f));

    //// TODO(student): Draw the square
    //RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0.5f, 0), glm::vec3(0.25f));
    //// circle
    //RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(0, 3, 0), glm::vec3(0.5f));
